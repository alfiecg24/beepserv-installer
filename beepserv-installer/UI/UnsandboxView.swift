    ...
    var body: some View {            
        VStack {
                Text("Unsandboxing")
                    ...
                    .padding()
                Text("BeepServ installer uses the 100% reliable MacDirtyCow exploit to unsandbox and copy the kernelcache. Press the button below to run the exploit - you only need to do this once.")
